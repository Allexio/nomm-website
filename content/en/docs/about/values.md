---
title: Our values
description: An overview of the NOMM team's values
weight: 4
---

## Transparency & AI

We pride ourselves on our transparency.<br>
NOMM is fully open and licensed under the [GNU General Public License v3.0](https://www.gnu.org/licenses/gpl-3.0.en.html).<br>
All of [its code](https://github.com/allexio/nomm), and the [code of this website](https://github.com/Allexio/nomm-website), are hosted on Github.
...
> [!NOTE] During the development of NOMM, we have used AI to varying degrees.
...
In fact, even if NOMM wanted to access information it shouldn't, [it would not be able to](/docs/about/flatpak-security/).
...
If you want to help us, please don't hesitate to participate to the project by testing the app and maybe even contributing by [adding support for your games](/docs/adding-your-game).
